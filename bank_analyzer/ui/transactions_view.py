...
class TransactionsView(QWidget):
    def __init__(self) -> None:
        ...
        filter_row_1.addWidget(QLabel(self.tr('From:')))
        filter_row_1.addWidget(self._date_from)
        filter_row_1.addWidget(QLabel(self.tr('To:')))
        filter_row_1.addWidget(self._date_to)
        filter_row_1.addWidget(QLabel(self.tr('Amount:')))
        filter_row_1.addWidget(self._amount_min_input)
        filter_row_1.addWidget(QLabel(self.tr('–')))
        filter_row_1.addWidget(self._amount_max_input)
        filter_row_1.addStretch()

        filter_row_2 = QHBoxLayout()
        filter_row_2.addWidget(QLabel(self.tr('Category:')))
        filter_row_2.addWidget(self._filter_category_combo, stretch=1)
        filter_row_2.addWidget(QLabel(self.tr('Description:')))
        filter_row_2.addWidget(self._description_input, stretch=4)
